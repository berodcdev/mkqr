...
def build_parser() -> argparse.ArgumentParser:
    p = ui.Parser(
        ...
        epilog=(
            ...
            "  mkqr https://example.com -O ~/Documents/site.png\n"
            "  mkqr https://example.com -O ~/Documents/        # nome automático pelo conteúdo\n"
            "  mkqr https://example.com -c                     # copia PNG para o clipboard\n"
            "  mkqr https://example.com -O site.png --open     # salva e abre\n"
            "  mkqr https://example.com -O site.png --logo logo.png\n"
            "  mkqr 'texto qualquer' -O card.svg --dark '#0a2540'\n"
            "  mkqr https://example.com -O site.png -b 4 --light white   # clássico, com margem\n"
